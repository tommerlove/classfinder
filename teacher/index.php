    ...
    <div class="login-box">
        <div class="thfont">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <p class="login-box-msg">ระบบแจ้งช่องทางติดต่อครู นักเรียน</p>

                        <form role="form" method="POST" action="reg_check.php">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" data-inputmask='"mask": "9-9999-99999-99-9"' id="regid" name="regid" placeholder="เลขประจำตัวประชาชน" data-mask>
