<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">นำเข้าผู้ใช้</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">นำเข้าผู้ใช้</a></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-12 offset-md-3">
                ...
                <div class="card-header">
                    <h3 class="card-title">นำเข้าผู้ใช้</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal formular" name="form1" id="confirm-form" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                <label>นำเข้าผู้ใช้ <font color="red">**</font></label>
                                    <div class="custom-file">
                                        <input type="hidden" name="MAX_FILE_SIZE" value="2000000" />
                                        <input type="file" class="custom-file-input" id="file" name="file" />
                                        <label class="custom-file-label" for="file">นำเข้าผู้ใช้</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <button type="submit" onclick="return (OnUploadCsvFile())" class="btn btn-success"><i class="fas fa-upload"></i> อัพโหลดข้อมูล</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <a href="teacher_import.xml" download="teacher_import" class="btn btn-primary"><i class="fas fa-download"></i> ตัวอย่างไฟล์</a>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function(){
    ...
    $.ajax({
        url:'user_manage_upload_save.php',
        data:$(this).serialize(),
