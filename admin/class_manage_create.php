<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">เพิ่มชั้นเรียน</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">เพิ่มชั้นเรียน</a></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-6 col-12 offset-md-3">
                ...
                <div class="card-header">
                    <h3 class="card-title">เพิ่มชั้นเรียน</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="class_name" name="class_name" placeholder="เช่น มัธยมศึกษาปีที่ ?" required>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function(){
    ...
    $.ajax({
        url:'class_manage_create_save.php',
        data:$(this).serialize(),
