                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($r1['fb'] != ''){ ?>
                                            <center><p><img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=<?php echo $r1['fb']; ?>&choe=UTF-8" title="fb_<?php echo $r1['id']; ?>" /></p></center>
                                        <?php } else { ?>
                                    ...
                                    <td>
                                        <?php if($r1['line'] != ''){ ?>
                                            <center><p><img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=<?php echo $r1['line']; ?>&choe=UTF-8" title="line_<?php echo $r1['id']; ?>" /></p></center>
                                        <?php } else { ?>
                                    ...
                                    <td>
                                        <?php if($r1['gg'] != ''){ ?>
                                            <!-- <center><a href="<?php echo $r1['gg']; ?>" target="blank" class="btn btn-outline-warning"><i class="fas fa-eye"></i> คลิก</a></center> -->
